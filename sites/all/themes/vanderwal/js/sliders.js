(function($) {
	$(function(){
		...
		$(".view--products-services-boxes .view-content").append('<div class="views-row"><div class="views-field views-field-title"><span class="field-content"><a href="/faqs" style="pointer-events:initial;">FAQs</a></span></div><div class="views-field views-field-field-upload-image"><div class="field-content"><img typeof="foaf:Image" src="http://vanderwal.local/sites/default/files/styles/steel_advantage_thumbnail/public/s_img4_1.jpg" width="231" height="231" alt=""></div></div><div class="views-field views-field-view-node"><span class="field-content"><a href="/faqs">+</a></span></div></div>');
	});
